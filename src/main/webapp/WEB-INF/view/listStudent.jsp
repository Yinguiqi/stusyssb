...
<div style="width:600px;height: 600px;position: absolute;left:50%;top:50%;margin-left:-300px;margin-top:-300px;">
    <h3 style="text-align: center">学生管理系统</h3>
    //查询学生
    <div class="retrieveDIV" style="width: 300px;margin: 0 auto;">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <c:forEach items="${students}" var="s" varStatus="status">
                <tr>
                    ...
                    <td>${s.birthday}</td>
                        <%--修改学生信息--%>
                    <td><a href="${pageContext.request.contextPath}/LoginController/editStudent?id=${s.id}"><span class="glyphicon glyphicon-edit"></span> </a></td>
                        <%--删除学生信息--%>
    ...
    <div class="addDIV" style="width: 300px;margin: 0 auto;">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <form method="post" action="${pageContext.request.contextPath}/LoginController/addStudent" role="form">
